    <footer class="site-footer">
        <div class="container footer-grid">
            ...
            <div>
                <h2>Contact</h2>
                <a href="mailto:hello@futurescholars.in">hello@futurescholars.in</a>
                <a href="tel:+919999999999">+91 99999 99999</a>
                <span>Mon to Sat, 9:00 AM - 7:00 PM</span>
            </div>
        </div>
        <div class="container footer-bottom">
            <span>&copy; <?php echo date('Y'); ?> Future Scholars. All rights reserved.</span>
            <span>Designed for fast shared hosting.</span>
        </div>
    </footer>
